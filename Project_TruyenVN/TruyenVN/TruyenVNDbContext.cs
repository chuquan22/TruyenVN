    ...
    public class TruyenVNDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                new User { user_id = 1, Email = "user@gmail.com", Password = "123", Name = "user", Gender = "Male", DateOfBirth = "12/12/2001", CreateAt = DateTime.Now, Role = 0 },
                new User { user_id = 2, Email = "admin@TruyenVn.com", Password = "123", Name = "admin", Gender = "Female", DateOfBirth = "22/07/2001", CreateAt = DateTime.Now, Role = 1 }
                );
            ...
            modelBuilder.Entity<Chapter>().HasData(
                ...
                new Chapter { chapter_id = 2, chapter_number = 2.1, story_id = 1, title = "Chapter 2.1", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688894100/Fairy%20Tail/chapter2.1_itasyx.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 3, chapter_number = 2.2, story_id = 1, title = "Chapter 2.2", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688894100/Fairy%20Tail/chapter2.2_itasyx.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 4, chapter_number = 3.1, story_id = 1, title = "Chapter 3.1", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688894100/Fairy%20Tail/chapter3.1_itasyx.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 5, chapter_number = 3.2, story_id = 1, title = "Chapter 3.2", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688894100/Fairy%20Tail/chapter3.2_itasyx.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 5, chapter_number = 1, story_id = 2, title = "", content = "Error", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 6, chapter_number = 2.1, story_id = 2, title = "Konohamaru", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688895954/Naruto/chapter2.1_c5wrar.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 7, chapter_number = 2.2, story_id = 2, title = "Konohamaru-next", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688895954/Naruto/chapter2.2_c5wrar.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 8, chapter_number = 3.1, story_id = 2, title = "Uchiha Sasuke", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688895954/Naruto/chapter3.1_c5wrar.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 9, chapter_number = 3.2, story_id = 2, title = "Uchiha Sasuke-next", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688895954/Naruto/chapter3.2_c5wrar.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 10, chapter_number = 1.1, story_id = 3, title = "Bắt đầu chuyến hành trình", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688896729/One%20Piece/chapter1.1_qjkjcz.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 11, chapter_number = 1.2, story_id = 3, title = "Bắt đầu chuyến hành trình - next", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688896729/One%20Piece/chapter1.2_qjkjcz.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 12, chapter_number = 1.3, story_id = 3, title = "Bắt đầu chuyến hành trình - next", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688896729/One%20Piece/chapter1.3_qjkjcz.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 13, chapter_number = 2, story_id = 3, title = "Chapter", content = "Error", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 14, chapter_number = 3.1, story_id = 3, title = "Thợ săn hải tặc zoro", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688897211/One%20Piece/chapter3.1_klvvkc.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 15, chapter_number = 3.2, story_id = 3, title = "Thợ săn hải tặc zoro - next", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688897211/One%20Piece/chapter3.2_klvvkc.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 16, chapter_number = 1, story_id = 8, title = "Thiên tài rơi rụng", content = "https://res.cloudinary.com/dhboy15q8/raw/upload/v1688897810/%C4%90%C3%A2%CC%81u%20Pha%CC%81%20Th%C6%B0%C6%A1ng%20Khung/chapter1_lpk36g.json", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 17, chapter_number = 2, story_id = 8, title = "Đấu khí đại lục", content = "https://res.cloudinary.com/dhboy15q8/raw/upload/v1688897951/%C4%90%C3%A2%CC%81u%20Pha%CC%81%20Th%C6%B0%C6%A1ng%20Khung/chapter2_rd9jwr.json", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 17, chapter_number = 3, story_id = 8, title = "Khách nhân", content = "https://res.cloudinary.com/dhboy15q8/raw/upload/v1688897951/%C4%90%C3%A2%CC%81u%20Pha%CC%81%20Th%C6%B0%C6%A1ng%20Khung/chapter3_rd9jwr.json", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 17, chapter_number = 4, story_id = 8, title = "Vân Lam tông", content = "https://res.cloudinary.com/dhboy15q8/raw/upload/v1688897951/%C4%90%C3%A2%CC%81u%20Pha%CC%81%20Th%C6%B0%C6%A1ng%20Khung/chapter4_rd9jwr.json", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 17, chapter_number = 5, story_id = 8, title = "Tụ Khí Tán", content = "https://res.cloudinary.com/dhboy15q8/raw/upload/v1688897951/%C4%90%C3%A2%CC%81u%20Pha%CC%81%20Th%C6%B0%C6%A1ng%20Khung/chapter5_rd9jwr.json", create_at= DateTime.Now , update_at = DateTime.Now},
                );
        }
