    ...
    public class TruyenVNDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Story>().HasData(
                new Story { story_id = 1, story_name = "Hội pháp sư - Fairy Tail", author_id = 1, description = "Xuyên suốt câu chuyện là cuộc phiêu lưu của một Sorceress tên là Lucy Heartphilia, sau khi cô tham gia vào hiệp hội hội Fairy Tail, cô đã cùng với Natsu Dragneel hành trình để đi tìm một con rồng tên là Igneel.", View = 50, story_image = "https://news-w.com/wp-content/uploads/2022/03/ve-hoi-phap-su-thumbnail.jpg", create_at = DateTime.Today, update_at = DateTime.Today, isComic = true },
                new Story { story_id = 2, story_name = "Naruto", author_id = 2, description = "Câu chuyện xoay quanh Uzumaki Naruto, một ninja trẻ muốn tìm cách khẳng định mình để được mọi người công nhận và nuôi ước mơ trở thành Hokage - người lãnh đạo Làng Lá. ", View = 30, story_image = "https://upload.wikimedia.org/wikipedia/en/9/94/NarutoCoverTankobon1.jpg", create_at = DateTime.Today, update_at = DateTime.Today, isComic = true },
                new Story { story_id = 3, story_name = "Đảo Hải Tặc - One Piece", author_id = 3, description = ". One Piece kể về cuộc hành trình của Monkey D. Luffy - thuyền trưởng của băng hải tặc Mũ Rơm và các đồng đội của cậu. Luffy tìm kiếm vùng biển bí ẩn nơi cất giữ kho báu lớn nhất thế giới One Piece, với mục tiêu trở thành Vua Hải Tặc.", View = 28, story_image = "https://i.truyenvua.com/slider/290x191/slider_1559211185.jpg?gt=hdfgdfg&mobile=2", create_at = DateTime.Today, update_at = DateTime.Today, isComic = true },
