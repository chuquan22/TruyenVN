    ...
    public class TruyenVNDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Chapter>().HasData(
                ...
                new Chapter { chapter_id = 7, chapter_number = 2.1, story_id = 2, title = "Konohamaru", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688895954/Naruto/chapter2.1_c5wrar.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 8, chapter_number = 2.2, story_id = 2, title = "Konohamaru-next", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688895954/Naruto/chapter2.2_c5wrar.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 9, chapter_number = 3.1, story_id = 2, title = "Uchiha Sasuke", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688895954/Naruto/chapter3.1_c5wrar.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 10, chapter_number = 3.2, story_id = 2, title = "Uchiha Sasuke-next", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688895954/Naruto/chapter3.2_c5wrar.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 11, chapter_number = 1.1, story_id = 3, title = "Bắt đầu chuyến hành trình", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688896729/One%20Piece/chapter1.1_qjkjcz.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 12, chapter_number = 1.2, story_id = 3, title = "Bắt đầu chuyến hành trình - next", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688896729/One%20Piece/chapter1.2_qjkjcz.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 13, chapter_number = 1.3, story_id = 3, title = "Bắt đầu chuyến hành trình - next", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688896729/One%20Piece/chapter1.3_qjkjcz.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 14, chapter_number = 2, story_id = 3, title = "Chapter", content = "Error", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 15, chapter_number = 3.1, story_id = 3, title = "Thợ săn hải tặc zoro", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688897211/One%20Piece/chapter3.1_klvvkc.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
                new Chapter { chapter_id = 16, chapter_number = 3.2, story_id = 3, title = "Thợ săn hải tặc zoro - next", content = "https://res.cloudinary.com/dhboy15q8/image/upload/v1688897211/One%20Piece/chapter3.2_klvvkc.jpg", create_at= DateTime.Now , update_at = DateTime.Now},
